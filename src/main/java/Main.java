...
public class Main {
    ...
    public static void main(String[] args)  {
        ...
        Order order2 = new Order(tugce, productList1);
        Order order3 = new Order(ceyhun, productList3);
        Order order5 = new Order(ceyhun,productList2);
        orderService.save(ceyhun,order5);
        ...
        System.out.println();
        orderService.findSectorByLowerThenX(750.0, "Jun");
        System.out.println();
        orderService.findSumOrderByJoinDate("Jun");
